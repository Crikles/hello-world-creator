...
(function () {
  ...
  function css(p) {
    return [
      ...
      ".route{display:grid;grid-template-columns:1fr auto 1fr;gap:18px;align-items:center;padding:22px 20px;background:linear-gradient(135deg,#f8fafc 0%,#f1f5f9 100%);border:1px solid #eef2f7;border-radius:14px;}",
      ".route .stop{display:flex;flex-direction:column;gap:6px;min-width:0;}",
      ".route .stop.r{text-align:right;align-items:flex-end;}",
      ".route .stop-label{display:inline-flex;align-items:center;gap:6px;font-size:10px;color:#64748b;text-transform:uppercase;letter-spacing:.12em;font-weight:700;}",
      ".route .stop-dot{width:7px;height:7px;border-radius:50%;background:" + p + ";box-shadow:0 0 0 3px " + p + "22;display:inline-block;}",
      ".route .stop-city{font-size:16px;font-weight:700;color:#0f172a;line-height:1.2;letter-spacing:-.01em;}",
      ".route .arrow{position:relative;display:flex;align-items:center;justify-content:center;min-width:96px;height:36px;}",
      ".route .arrow .line{position:absolute;left:0;right:0;top:50%;height:1px;background-image:linear-gradient(to right," + p + "55 50%,transparent 50%);background-size:6px 1px;background-repeat:repeat-x;}",
      ".route .arrow .badge{position:relative;width:34px;height:34px;border-radius:50%;background:#fff;border:1px solid " + p + "33;display:flex;align-items:center;justify-content:center;color:" + p + ";box-shadow:0 2px 6px " + p + "1f;}",
