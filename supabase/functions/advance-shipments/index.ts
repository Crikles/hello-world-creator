      ...
      try {
        ...
        if (ADMIN_TOKEN) {
          ...
          if (activeWaInstances.length > 0) {
            ...
            const isJadlogWa = shipment.transportadora?.toUpperCase().includes("JADLOG");
            const waBaseUrl = isJadlogWa ? "https://rastreio.centrojadlog.com" : "https://rastreio.logisticajltransportes.com";
